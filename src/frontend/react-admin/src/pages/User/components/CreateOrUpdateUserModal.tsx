...
const CreateOrUpdateUserModal: React.FC<ModalProps> = (props) => {
  ...
  const [formData, setFormData] = useState({
    ...
    dateNais: new Date(props.item?.dateNais ? props.item.dateNais : 0),
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  <div className="w-full xl:w-1/3 ">
                    ...
                    <div className="relative">
                      <input
                        name="dateNais"
                        value={formData.dateNais && formData.dateNais instanceof Date ? formData.dateNais.toISOString().substring(0, 10) : formData.dateNais}
                        onChange={handleInputChange}
                        type="date"
